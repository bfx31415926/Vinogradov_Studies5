/* ПРИМЕЧАНИЯ
    1. Пример хоть и работает, но MyService не сработает на длинном интервале -
        вместо него надо использовать ForeGround Service - см. проект 'MyServices'
    2. Прилось заменить во всех вызовах createPendingResult..., 0, ...) на
       createPendingResult..., new Intent(), ...), иначе программа вылетала
 */

package com.example.study95;
